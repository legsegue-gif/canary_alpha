...
[Website](https://github.com/legsegue-gif/canary_alpha) · [User Guide](https://github.com/legsegue-gif/canary_alpha) · [Download](#-download) · [Report an Issue](https://github.com/legsegue-gif/canary_alpha/issues)
...
If Canary is useful to you, you can also [support the project on WeChat](docx/sponsor.jpg).
...
| --- | --- | --- | --- |
| iOS / iPadOS | [App Store](https://github.com/legsegue-gif/canary_alpha) · [TestFlight](https://github.com/legsegue-gif/canary_alpha) (beta) | App Store, or unsigned IPA in [Releases](https://github.com/legsegue-gif/canary_alpha/releases/latest) | iOS 15.0 or later |
...
| HarmonyOS | [canary-ohos](https://github.com/legsegue-gif/canary_alpha) | Maintained in a separate repository | — |

The [download page](https://github.com/legsegue-gif/canary_alpha/releases/latest) on the website lists the same builds.
...
The [User Guide](https://github.com/legsegue-gif/canary_alpha) (Chinese) covers providers, memory, world books and more.
