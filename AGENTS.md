...
> Canary is a cross-platform Flutter LLM chat client (Android / iOS / macOS / Windows / Linux).
...
- The following are generated or build artifacts. Never hand-edit them:
  ...
  - `.dart_tool/**`
  - `build/**`
- The package name is `Canary`. Existing imports use `package:Canary/...` everywhere. Do not "normalize" the package name.
