...
typedef void (^CanaryISHChunkHandler)(NSString *runId, BOOL isStderr, NSData *chunk);
typedef void (^CanaryISHDoneHandler)(NSDictionary<NSString *, id> *result);

@interface CanaryISHExecutor : NSObject
