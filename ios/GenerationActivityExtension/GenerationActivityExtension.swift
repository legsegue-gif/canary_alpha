...
struct GenerationActivityWidget: Widget {
  var body: some WidgetConfiguration {
    ActivityConfiguration(for: CanaryGenerationActivityAttributes.self) { context in
      HStack(spacing: 12) {
...
private func symbol(_ state: CanaryGenerationActivityAttributes.ContentState, stale: Bool) -> String {
...
private func activityIsStale(_ context: ActivityViewContext<CanaryGenerationActivityAttributes>) -> Bool {
