...
import 'package:Canary/core/services/mcp/workspace_stdio_transport.dart';
import 'package:Canary/core/services/mcp/workspace_stdio_command.dart';
...
''',
      ...
      expect(output.toString().trim(), '200:canary overlay ok');
    },
    skip:
        !Platform.isIOS || !const bool.fromEnvironment('MCP_STDIO_NODE_SMOKE'),
  );
    ...
    (tester) async {
      ...
      await expectLater(
        requireWorkspaceStdioCommand(
          runtime: runtime,
          command: 'canary-nonexistent-mcp-command',
          cwd: '/root',
          environment: const {},
