...
@Config(sdk = [28], application = CanaryApplication::class)
class ScheduledTasksTest {
    ...
    private val app get() = RuntimeEnvironment.getApplication() as CanaryApplication
    private val prefs get() = app.getSharedPreferences("canary_scheduled_tasks", Context.MODE_PRIVATE)
