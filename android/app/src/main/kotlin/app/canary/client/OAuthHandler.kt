...
internal object OAuthHandler {
    ...
    private const val CALLBACK_SCHEME = "app.canary.client"
        ...
        MethodChannel(messenger, CHANNEL_NAME).setMethodCallHandler { call, result ->
            when (call.method) {
                "authenticate" -> {
                    ...
                    if (current == null) result.error("foreground_required", "Open Canary to authorize this connection.", null)
    ...
    private fun authenticate(
        ...
        if (
            ...
            result.error(
                "invalid_arguments",
                "A valid HTTPS authorization URL, state, and Canary callback URI are required.",
                null,
            )
            return
        }
