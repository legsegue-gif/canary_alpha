...
class GenerationForegroundService : Service() {
    companion object { const val STOP = "canary.background.STOP" }
    private val runtime get() = (application as CanaryApplication).backgroundRuntime
        ...
        try {
            ...
            if (intent?.action == STOP) runtime.stopTasks()
                ...
                if (runtime.hasScheduledRuns) android.os.Handler(mainLooper).post {
                    val app = application as CanaryApplication
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = getSystemService(PowerManager::class.java).newWakeLock(
            PowerManager.PARTIAL_WAKE_LOCK, "Canary:Generation").apply {
