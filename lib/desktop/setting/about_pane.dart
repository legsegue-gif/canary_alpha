...
class _DesktopAboutPaneState extends State<DesktopAboutPane> {
  ...
  Future<void> _onAppNameTap() async {
    ...
    _appNameTapCount = 0;
    Haptics.medium();
    final added = await context.read<SettingsProvider>().unlockCanarySearch();
    if (!mounted) return;
    final l10n = AppLocalizations.of(context)!;
    showAppSnackBar(
      context,
      message: added
          ? l10n.aboutPageCanarySearchUnlocked
          : l10n.aboutPageCanarySearchAlreadyUnlocked,
              ...
              _DeskCard(
                ...
                children: [
                  ...
                  _DeskNavRow(
                    ...
                    onTap: () => _openUrl(
                      'https://github.com/legsegue-gif/canary_alpha/blob/main/LICENSE',
                    ),
                  ),
                  const _DeskRowDivider(),
                  _DeskNavRowSvg(
                  ...
                  _DeskNavRowSvg(
                    ...
                    onTap: () => _openUrl('https://discord.gg/5BXdVPyen'),
                  ),
                  const _DeskRowDivider(),
...
Future<void> _showSponsorDesktopDialog(BuildContext context) async {
  ...
  final l10n = AppLocalizations.of(context)!;
  final isDark = Theme.of(context).brightness == Brightness.dark;
  const afdianUrl = 'https://github.com/legsegue-gif/canary_alpha';
