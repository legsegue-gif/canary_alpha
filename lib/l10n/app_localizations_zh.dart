...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get sponsorPageAfdianSubtitle => 'legsegue-gif/canary_alpha';
  ...
  @override
  String get backupPageRestartContent => '导入成功。重启 Canary 后将安全应用。';

  @override
  String backupPageRestartContentWithSkipped(int count) {
    return '导入已完成，但已跳过 $count 个消息顺序非法的会话。重启 Canary 后将安全应用已导入的数据。';
  }

  @override
  String get restartAppFailedMessage => 'Canary 无法自动重启，请完全关闭后重新打开。';

  @override
  String get backupRestoreRolledBackTitle => '恢复已回滚';

  @override
  String get backupRestoreRolledBackContent => '恢复未能完成。Canary 已验证并保留原有数据。';
  ...
  String get backupRestoreFailureContent =>
      'Canary 无法验证完整的原有或新数据，因此未打开聊天数据。请关闭 Canary 后重试；若问题反复出现，请保留诊断码以便支持人员排查。';

  @override
  String get backupRestoreBusinessLeaseUnavailableTitle => 'Canary 已在运行';
  ...
  @override
  String get startupRecoveryResetFailed => '重置失败。请彻底关闭 Canary 后重新打开。';
  ...
  String get startupRecoveryResetDialogContent =>
      '这将永久删除本设备上 Canary 的数据库并重新开始。如果之后可能还需要这些数据，请先导出一份副本。此操作无法撤销。';
  ...
  String backupPageCherryStudioUnsupportedBackupVersion(String version) {
    return '此备份使用 Cherry Studio 格式版本 $version，Canary 目前尚无法导入。请改用 Cherry Studio v1 导出备份，或等待后续版本支持 Cherry Studio v2。';
  }
  ...
  @override
  String get aboutPageCanarySearchUnlocked => '有扇没有名字的门开了一条缝。去设置里找找看。';

  @override
  String get aboutPageCanarySearchAlreadyUnlocked => '这扇门你已经推开过了。';

  @override
  String get aboutPageAppName => 'Canary';
  ...
  @override
  String get settingsShare => 'Canary - 开源AI助手';
  ...
  @override
  String get legacyMemoryExportTitle => 'Canary 旧版记忆导出';
  ...
  String get migrationIntroSubtitle =>
      'Canary 将聊天记录迁移到更快的 SQLite 数据库。升级会在应用打开前完成，避免新旧数据同时写入。';
  ...
  String get migrationBackingUpSubtitle =>
      '正在导出设置、聊天记录、上传文件、图片和字体。请保持 Canary 开启，等待备份完成。';
  ...
  String get migrationMigratingSubtitle =>
      '正在分批写入会话和消息，避免超大聊天记录占满内存。请保持 Canary 在前台，等待迁移完成。';
  ...
  String get migrationCompleteSubtitle =>
      '你的聊天记录已迁移到 SQLite。请重启 Canary 进入升级后的应用。';
  ...
  @override
  String get migrationRestartButton => '重启 Canary';
  ...
  String get migrationSkipDialogMessage =>
      'Canary 将以空的聊天数据库启动。旧的聊天记录会保留在磁盘上（重命名为 .retired 后缀），但不会被迁移，也不会在应用中显示。之后如需找回，请使用已保存的备份 ZIP。';
...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get backupPageRestartContent => '匯入成功。重新啟動 Canary 後將安全套用。';

  @override
  String backupPageRestartContentWithSkipped(int count) {
    return '匯入已完成，但已略過 $count 個訊息順序無效的會話。重新啟動 Canary 後將安全套用已匯入的資料。';
  }

  @override
  String get restartAppFailedMessage => 'Canary 無法自動重新啟動，請完全關閉後再重新開啟。';

  @override
  String get backupRestoreRolledBackTitle => '已保留原有資料';

  @override
  String get backupRestoreRolledBackContent => '還原未能完成。Canary 已驗證並保留先前的資料。';
  ...
  @override
  String get backupRestoreFailureContent =>
      'Canary 無法驗證完整的原有或新資料，因此未開啟聊天資料。請關閉 Canary 後重試；若問題持續發生，請保留診斷碼以供支援人員排查。';

  @override
  String get backupRestoreBusinessLeaseUnavailableTitle => 'Canary 已在執行';
  ...
  @override
  String get startupRecoveryResetFailed => '重設失敗。請完全關閉 Canary 後再重新開啟。';
  ...
  @override
  String get startupRecoveryResetDialogContent =>
      '這會永久刪除本裝置上 Canary 的資料庫並重新開始。如果之後可能還需要這些資料，請先匯出一份副本。此操作無法復原。';
  ...
  @override
  String backupPageCherryStudioUnsupportedBackupVersion(String version) {
    return '此備份使用 Cherry Studio 格式版本 $version，Canary 目前尚無法匯入。請改用 Cherry Studio v1 匯出備份，或等待後續版本支援 Cherry Studio v2。';
  }
  ...
  @override
  String get aboutPageCanarySearchUnlocked => '有扇沒有名字的門開了一條縫。去設定裡找找看。';

  @override
  String get aboutPageCanarySearchAlreadyUnlocked => '這扇門你已經推開過了。';
  ...
  @override
  String get settingsShare => 'Canary - 開源AI助理';
  ...
  @override
  String get legacyMemoryExportTitle => 'Canary 舊版記憶匯出';
  ...
  @override
  String get migrationIntroSubtitle =>
      'Canary 將聊天記錄遷移到更快的 SQLite 資料庫。升級會在應用程式開啟前完成，避免新舊資料同時寫入。';
  ...
  @override
  String get migrationBackingUpSubtitle =>
      '正在匯出設定、聊天記錄、上傳檔案、圖片和字體。請保持 Canary 開啟，等待備份完成。';
  ...
  @override
  String get migrationMigratingSubtitle =>
      '正在分批寫入對話和訊息，避免超大聊天記錄占滿記憶體。請保持 Canary 在前台，等待遷移完成。';
  ...
  @override
  String get migrationCompleteSubtitle =>
      '你的聊天記錄已遷移到 SQLite。請重啟 Canary 進入升級後的應用程式。';
  ...
  @override
  String get migrationRestartButton => '重啟 Canary';
  ...
  @override
  String get migrationSkipDialogMessage =>
      'Canary 將以空的聊天資料庫啟動。舊的聊天記錄會保留在磁碟上（重新命名為 .retired 後綴），但不會被遷移，也不會在應用程式中顯示。之後如需找回，請使用已儲存的備份 ZIP。';
