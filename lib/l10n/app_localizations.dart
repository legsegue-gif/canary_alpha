...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Import completed, but {count} conversations with invalid message ordering were skipped. Restart Canary to apply the imported data safely.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This backup uses Cherry Studio format version {version}, which Canary cannot import yet. Export from Cherry Studio v1 instead, or wait for a Canary update that supports Cherry Studio v2 backups.'**
  ...
  /// No description provided for @aboutPageCanarySearchUnlocked.
  ///
  /// In en, this message translates to:
  /// **'An unnamed door opened a crack. You might find it in Settings.'**
  String get aboutPageCanarySearchUnlocked;

  /// No description provided for @aboutPageCanarySearchAlreadyUnlocked.
  ///
  /// In en, this message translates to:
  /// **'You\'ve already been through this door.'**
  String get aboutPageCanarySearchAlreadyUnlocked;
  ...
  ///
  /// In en, this message translates to:
  /// **'Canary - Open Source AI Assistant'**
  ...
  /// In en, this message translates to:
  /// **'Canary'**
  String get searchServiceNameCanary;
