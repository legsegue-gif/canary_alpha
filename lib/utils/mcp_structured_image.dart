...
const String kMcpToolResultEnvelopePrefix = '{"canary":"mcp_tool_result"';
...
/// `{"canary":"mcp_tool_result",...}`. New writes must not produce this.
McpToolResult? tryDecodeLegacyMcpToolResultEnvelope(String content) {
  ...
  try {
    ...
    if (decoded['canary'] != kMcpToolResultKind) return null;
