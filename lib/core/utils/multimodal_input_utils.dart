...
const String multimodalInternalMediaPathsKey = '_canary_media_paths';
const String multimodalInternalRevisionIdKey = '_canary_revision_id';
...
/// Stripped before anything reaches the wire, like the other `_canary_` keys.
const String multimodalInternalDocumentPathsKey = '_canary_document_paths';
...
/// One `_canary_document_paths` entry.
...
const String multimodalInternalClaudeContainerKey = '_canary_claude_container';
const String multimodalInternalClaudeTurnKey = '_canary_claude_turn';
const String multimodalInternalGeminiThoughtSignatureKey =
    '_canary_gemini_thought_signature';
...
/// Encode a structured media ref for `_canary_media_paths`.
///
...
/// Parse usable refs from a `_canary_media_paths` list value.
///
...
/// URI-only view of `_canary_media_paths` (String|Map entries).
