...
const String canaryContextSegmentsKey = '_canary_ctx_segments';
...
class ContextSegmentTags {
  ...
  static List<Map<String, dynamic>> read(Map<String, dynamic> message) {
    final raw = message[canaryContextSegmentsKey];
  ...
  static void write(
    ...
    if (tags.isEmpty) {
      message.remove(canaryContextSegmentsKey);
      return;
    }
    message[canaryContextSegmentsKey] = tags;
  }
