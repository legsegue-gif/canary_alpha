...
import 'package:Canary/core/services/sandbox/channel_command_run.dart';
import 'package:Canary/core/services/sandbox/channel_pty_session.dart';
...
class AndroidProotRuntime implements WorkspaceStdioRuntime {
  ...
  Future<void> _adoptOnDiskInstall() async {
    ...
    final versionFile = File(p.join(rootfsDir.path, kCanaryVersionFile));
