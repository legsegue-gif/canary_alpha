...
class CanarySearchService extends SearchService<CanaryOptions> {
  CanarySearchService({super.client});

  static const _mask = 'canary';
  ...
  Future<SearchResult> search({
    ...
    required CanaryOptions serviceOptions,
  }) async {
    ...
    try {
      ...
      final uri = Uri.https('search.canaryas.top', '/v1/search', {
        'q': query,
      ...
      throw Exception('Canary search failed: $e');
    } finally {
