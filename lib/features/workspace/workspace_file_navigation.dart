...
Future<File?> resolveWorkspaceLinkedFile(
  ...
  final parsed = link == null ? null : CanaryLink.tryParse(link);
  if (parsed == null || parsed.kind == CanaryLinkKind.terminal) return null;
  try {
...
Future<void> openWorkspaceLinkedFile(
  ...
  final parsed = link == null ? null : CanaryLink.tryParse(link);
  if (parsed?.kind == CanaryLinkKind.terminal) {
