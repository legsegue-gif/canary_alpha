...
import 'package:Canary/features/workspace/widgets/files/workspace_file_thumbnail.dart';
import 'package:Canary/features/workspace/widgets/preview/file_preview.dart';
  ...
  Future<({File file, String fileName})?> _zipDirectory(
    ...
    final temp = File(
      p.join(
        ...
        'canary-$zipName-${DateTime.now().microsecondsSinceEpoch}.zip',
      ),
    );
    await _runMutation(
