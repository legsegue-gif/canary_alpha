...
/// Strips iTerm-style OSC 1337 `CanaryOpenURL` sequences from a PTY byte
...
class Osc1337Interceptor {
  ...
  static final RegExp _canaryOpen = RegExp(
    r'^1337\s*;\s*CanaryOpenURL=(.*)$',
    dotAll: true,
  );
  ...
  bool _handleCanaryOpen(String body) {
    final match = _canaryOpen.firstMatch(body);
