import 'package:Canary/features/workspace/workspace_file_navigation.dart';
import 'dart:async';
...
import 'package:Canary/features/workspace/terminal/widgets/system_terminal_card.dart';
import 'package:Canary/features/workspace/terminal/widgets/terminal_key_bar.dart';
import 'package:Canary/features/workspace/terminal/widgets/terminal_tab_strip.dart';
...
class _TerminalPageState extends State<TerminalPage> {
  ...
  Future<void> _handleOpenUrl(TerminalSession session, Uri uri) async {
    ...
    if (uri.scheme == 'canary') {
      ...
      final link = CanaryLink.tryParse(uri.toString());
      if (link == null) {
        showAppSnackBar(context, message: l10n.terminalNotAvailable);
        return;
      }
