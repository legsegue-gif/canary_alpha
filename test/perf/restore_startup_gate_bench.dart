...
//   CANARY_BENCH_ASSET_MB (default 150) and CANARY_BENCH_ASSET_FILES (300).
import 'dart:convert';
import 'dart:io';
import 'dart:math';
...
void main() {
  ...
  test(
    ...
    () async {
      final assetMb =
          int.tryParse(Platform.environment['CANARY_BENCH_ASSET_MB'] ?? '') ??
          150;
      final assetFiles =
          int.tryParse(
            Platform.environment['CANARY_BENCH_ASSET_FILES'] ?? '',
          ) ??
          300;
      final root = await Directory.systemTemp.createTemp(
        'canary_restore_bench_',
      );
      ...
      final entries = <String, dynamic>{
        ...
        'database/canary.db': await _descriptor(candidateDatabase),
      };
      ...
      final rollback = Platform.environment['CANARY_BENCH_ROLLBACK'] == '1';
