...
import 'package:Canary/shared/widgets/streaming_rich_text.dart';
...
void main() {
  ...
  const visualFont = String.fromEnvironment('CANARY_VISUAL_FONT');
  const emojiFont = String.fromEnvironment('CANARY_VISUAL_EMOJI_FONT');
  setUpAll(() async {
