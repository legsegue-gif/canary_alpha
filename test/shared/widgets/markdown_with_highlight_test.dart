...
import 'package:Canary/shared/widgets/markdown_line_lexer.dart';
import 'package:Canary/shared/widgets/markdown_with_highlight.dart';
import 'package:Canary/shared/widgets/export_capture_scope.dart';
import 'package:Canary/shared/widgets/mermaid_image_cache.dart';
...
这里是普通 Markdown 链接：[Canary GitHub](https://github.com/canary/Canary)
'''),
    );
    await tester.pump();
