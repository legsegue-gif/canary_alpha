...
import 'package:Canary/features/assistant/pages/assistant_settings_edit_skills_tab.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('canary_skills_tab_');
  });
