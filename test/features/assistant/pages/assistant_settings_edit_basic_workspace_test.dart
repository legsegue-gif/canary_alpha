...
import 'package:Canary/features/assistant/widgets/assistant_default_workspace_row.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = Directory.systemTemp.createTempSync('canary_assistant_ws_tab_');
