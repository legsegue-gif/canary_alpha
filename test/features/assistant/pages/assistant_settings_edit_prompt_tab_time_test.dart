...
import 'package:Canary/core/providers/quick_phrase_provider.dart';
...
import 'package:Canary/core/services/memory/memory_pipeline.dart';
import 'package:Canary/core/services/memory/memory_repository.dart';
import 'package:Canary/core/services/tts/tts_playback_models.dart';
import 'package:Canary/features/assistant/pages/assistant_settings_edit_page.dart';
...
_createAssistantProvider(
  ...
  final tempDir = await tester.runAsync(
    () => Directory.systemTemp.createTemp('canary_asst_edit_'),
  );
  ...
  return MultiProvider(
    ...
    child: MaterialApp(
      theme: ThemeData(
        ...
        fontFamily: Platform.environment['CANARY_TIME_SCREENSHOTS'] == null
            ? null
            : 'PromptTimePreview',
      ),
...
void main() {
  ...
  setUpAll(() async {
    if (Platform.environment['CANARY_TIME_SCREENSHOTS'] == null) return;
    ...
    for (final brightness in Brightness.values) {
      testWidgets(
        ...
        (tester) async {
          ...
          final screenshotDir = Platform.environment['CANARY_TIME_SCREENSHOTS'];
