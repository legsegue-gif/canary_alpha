...
import 'package:Canary/core/models/assistant_memory.dart';
import 'package:Canary/core/models/memory_entry.dart';
import 'package:Canary/core/models/user_profile_field.dart';
...
import 'package:Canary/features/settings/pages/legacy_memory_page.dart';
import 'package:Canary/features/settings/pages/memory_entries_page.dart';
import 'package:Canary/features/settings/pages/user_profile_page.dart';
...
void main() {
  ...
  testWidgets('legacy export text format', (tester) async {
    ...
    expect(text, contains('# Canary legacy memory export'));
