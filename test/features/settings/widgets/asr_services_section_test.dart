...
import 'package:Canary/core/services/asr/asr_service_options.dart';
import 'package:Canary/core/services/asr/sherpa_model_manager.dart';
import 'package:Canary/features/settings/widgets/asr_services_section.dart';
import 'package:Canary/features/settings/widgets/voice_service_widgets.dart';
...
void main() {
  ...
  testWidgets('editing Step and MiMo keeps advanced values not shown in UI', (
    ...
    expect(step.hotwords, const ['Canary', 'ASR']);
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(openAi.prompt, 'Canary vocabulary');
...
final class _ModelManagerFixture {
  ...
  static _ModelManagerFixture create() {
    final directory = Directory.systemTemp.createTempSync('canary-asr-ui-');
