...
// CANARY_SEARCH_QA_DIR=/tmp/settings-search CANARY_SEARCH_QA_FONT=/path/font.ttf
// flutter test test/features/settings/search/settings_search_visual_test.dart
void main() {
  final output = Platform.environment['CANARY_SEARCH_QA_DIR'];
  final fontPath = Platform.environment['CANARY_SEARCH_QA_FONT'];
  setUpAll(() async {
    if (fontPath != null) {
