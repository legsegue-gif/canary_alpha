...
import 'package:Canary/core/models/scheduled_task.dart';
...
import 'package:Canary/core/services/desktop_scheduled_tasks.dart';
import 'package:Canary/core/services/scheduled_task_store.dart';
import 'package:Canary/core/services/notification_service.dart';
import 'package:Canary/core/services/scheduled_tasks_service.dart';
import 'package:Canary/desktop/desktop_settings_page.dart';
import 'package:Canary/desktop/setting/scheduled_tasks_pane.dart';
import 'package:Canary/features/home/widgets/assistant_avatar.dart';
import 'package:Canary/features/scheduled_tasks/pages/scheduled_task_editor_page.dart';
import 'package:Canary/desktop/widgets/desktop_scheduled_task_tile.dart';
import 'package:Canary/desktop/widgets/desktop_scheduled_task_form.dart';
import 'package:Canary/desktop/widgets/desktop_select_dropdown.dart';
import 'package:Canary/features/workspace/widgets/desktop_workspace_text_field.dart';
import 'package:Canary/features/settings/widgets/custom_theme_widgets.dart';
...
void main() {
  ...
  final screenshots = Platform.environment['CANARY_SCHEDULE_SCREENSHOTS'];

  setUpAll(() async {
    if (screenshots == null) return;
    final bytes = await File(
      Platform.environment['CANARY_PREVIEW_FONT']!,
    ).readAsBytes();
    await (FontLoader(
      'ScheduledPreview',
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        try {
          ...
          expect(
            find.textContaining('Tasks run only while Canary is running'),
            findsOneWidget,
          );
          expect(
