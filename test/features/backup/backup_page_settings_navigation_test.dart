...
import 'package:Canary/desktop/setting/backup_pane.dart';
import 'package:Canary/features/backup/pages/backup_page.dart';
...
void main() {
  ...
  group('BackupPage mobile backup settings navigation', () {
    testWidgets('opens WebDAV settings as a full page and saves config', (
      ...
      await tester.enterText(fields.at(4), ' CanaryTest/1.0 ');
      ...
      expect(settings.webDavConfig.userAgent, 'CanaryTest/1.0');
    });
