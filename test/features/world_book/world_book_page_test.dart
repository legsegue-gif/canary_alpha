...
import 'package:Canary/desktop/setting/world_book_pane.dart';
import 'package:Canary/features/world_book/pages/world_book_page.dart';
...
void main() {
  ...
  final screenshotDir = Platform.environment['CANARY_WORLD_BOOK_SCREENSHOTS'];
  setUpAll(() async {
