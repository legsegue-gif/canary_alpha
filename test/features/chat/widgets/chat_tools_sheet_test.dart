...
import 'package:Canary/features/chat/widgets/chat_tools_sheet.dart';
import 'package:Canary/features/home/services/local_tool_labels.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = Directory.systemTemp.createTempSync('canary_chat_tools_sheet_');
