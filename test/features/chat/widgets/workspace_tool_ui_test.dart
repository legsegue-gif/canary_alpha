...
import 'package:Canary/features/chat/widgets/workspace_tool_detail.dart';
          ...
          _uiPart(
            ...
            meta: const WorkspaceToolMetadata(
              ...
              files: [
                WorkspaceToolFile(
                  path: '/workspace/result.txt',
                  link: 'canary://workspace/result.txt',
          ...
          _uiPart(
            ...
            meta: const WorkspaceToolMetadata(
              ...
              files: [
                WorkspaceToolFile(
                  path: 'src/empty.md',
                  link: 'canary://workspace/src/empty.md',
                ),
                WorkspaceToolFile(
                  path: 'src/attachments',
                  link: 'canary://workspace/src/attachments',
                  isDirectory: true,
                ),
              ],
            ),
