...
void main() {
  ...
  setUp(() async {
    root = Directory.systemTemp.createTempSync('canary_file_navigation_');
              ...
              metadata: const WorkspaceToolMetadata(
                ...
                files: [
                  WorkspaceToolFile(
                    ...
                    link: 'canary://workspace/note.txt',
                  ),
                ],
              ).toJson(),
            ),
          ...
          harness(
            markdown
                ? const MarkdownWithCodeHighlight(
                    text: '[folder](canary://workspace/folder)',
                    conversationId: 'c1',
                  )
                : const WorkspaceFileChip(
                    path: '/workspace/folder',
                    link: 'canary://workspace/folder',
                    isDirectory: true,
                    conversationId: 'c1',
                  ),
          ),
              ...
              metadata: const WorkspaceToolMetadata(
                ...
                files: [
                  WorkspaceToolFile(
                    ...
                    link: 'canary://workspace/plot.png',
    ...
    (tester) async {
      await tester.pumpWidget(
        harness(
          const WorkspaceFileChip(
            path: 'missing.txt',
            link: 'canary://workspace/missing.txt',
            conversationId: 'c1',
          ),
        ),
      );
