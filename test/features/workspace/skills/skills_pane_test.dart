...
import 'package:Canary/core/models/skill_record.dart';
...
import 'package:Canary/features/workspace/widgets/skills/skill_detail.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('canary_skills_pane_');
    try {
