...
import 'package:Canary/core/services/sandbox/rootfs_source.dart';
...
import 'package:Canary/features/workspace/pages/mirror_page.dart';
import 'package:Canary/features/workspace/widgets/environment/environment_dependencies_section.dart';
...
void main() {
  ...
  Future<void> setup(
    ...
    await tester.runAsync(() async {
      ...
      final directory = await Directory.systemTemp.createTemp('canary_env_ui_');
