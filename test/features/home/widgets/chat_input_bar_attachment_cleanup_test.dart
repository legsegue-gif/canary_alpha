...
import 'package:Canary/desktop/windows_paste_fix.dart';
...
import 'package:Canary/utils/image_compressor.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    appSupportDir = await Directory.systemTemp.createTemp(
      'canary_input_cleanup_app_',
    );
    userDir = await Directory.systemTemp.createTemp(
      'canary_input_cleanup_user_',
    );
