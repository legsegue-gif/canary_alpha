...
void main() {
  ...
  setUp(() async {
    tmp = await Directory.systemTemp.createTemp('canary_ws_prompt_');
  ...
  for (final platform in [TargetPlatform.android, TargetPlatform.iOS]) {
    test('fragment includes the ${platform.name} directory description', () {
      ...
      expect(fragment, contains('canary://workspace/rel/path'));
      expect(fragment, contains('canary://chat/outputs/x.txt'));
      expect(fragment, contains('canary://workspace/plot.png'));
