...
import 'package:Canary/core/services/memory/memory_tools.dart';
import 'package:Canary/core/services/memory/memory_trace.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    tempDir = await Directory.systemTemp.createTemp('canary_memory_tools_');
