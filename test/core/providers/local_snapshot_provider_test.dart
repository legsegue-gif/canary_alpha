...
import 'package:Canary/core/services/backup/local_snapshot_service.dart';
import 'package:Canary/core/services/backup/local_snapshot_settings.dart';
import 'package:Canary/core/services/backup/local_snapshot_store.dart';
...
void main() {
  ...
  group('LocalSnapshotProvider', () {
    ...
    setUp(() async {
      root = await Directory.systemTemp.createTemp('canary_snapshot_provider_');
