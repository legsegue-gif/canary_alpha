...
import 'package:Canary/core/models/quick_phrase.dart';
...
import 'package:Canary/core/providers/instruction_injection_group_provider.dart';
...
import 'package:Canary/core/providers/tag_provider.dart';
...
import 'package:Canary/core/services/memory_store.dart';
import 'package:Canary/core/services/quick_phrase_store.dart';
import 'package:Canary/core/services/world_book_store.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      expect(
        provider.servers.where((server) => server.id == 'canary_fetch'),
        hasLength(1),
      );
      ...
      expect(
        restored.servers.where((server) => server.id == 'canary_fetch'),
        hasLength(1),
      );
