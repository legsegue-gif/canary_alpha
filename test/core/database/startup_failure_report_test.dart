...
import 'package:Canary/core/database/startup_failure_report.dart';
...
void main() {
  ...
  setUp(() async {
    directory = await Directory.systemTemp.createTemp('canary_startup_report_');
  });
