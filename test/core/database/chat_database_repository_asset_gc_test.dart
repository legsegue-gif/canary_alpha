...
void main() {
  ...
  test('canary-file asset path dual-form text refs block GC', () async {
    final root = await Directory.systemTemp.createTemp('asset_gc_canary_');
    final repository = ChatDatabaseRepository.open(
      file: File('${root.path}/assets.sqlite'),
    );
    addTearDown(() async {
    ...
    const canonical = 'canary-file:///images/gen.png';
  ...
  test('dirty malformed attachment payload blocks GC until repaired', () async {
    ...
    const assetPath = r'C:\Users\Alice\Canary\images\corrupt.png';
