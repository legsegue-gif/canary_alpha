...
void main() {
  ...
  setUp(() async {
    ...
    rootfsDir = await Directory.systemTemp.createTemp('canary_proot_rootfs_');
    tmpDir = await Directory.systemTemp.createTemp('canary_proot_tmp_');
    ...
    for (final phase in [
      ...
      test('rejects $installedArch rootfs on $abi from $phase', () async {
        ...
        final marker = await File(
          '${rootfsDir.path}/$kCanaryVersionFile',
