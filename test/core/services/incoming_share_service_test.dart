...
import 'package:Canary/core/services/incoming_share_service.dart';
import 'package:Canary/core/services/chat/document_text_extractor.dart';
import 'package:Canary/utils/upload_dedupe.dart';
...
void main() {
  ...
  setUp(() {
    root = Directory.systemTemp.createTempSync('canary_incoming_');
