...
void main() {
  ...
  setUp(() async {
    root = await Directory.systemTemp.createTemp('canary_backup_parts_');
    PathProviderPlatform.instance = _FakePathProvider(root.path);
    SandboxPathResolver.debugSetDirs(docsDir: root.path, supportDir: root.path);
    SharedPreferences.setMockInitialValues({});
    final databaseFile = File('${root.path}/canary.db');
  ...
  test(
    ...
    () async {
      ...
      expect(image.uri, 'canary-file:///upload/restored.png');
