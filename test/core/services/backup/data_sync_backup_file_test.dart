  ...
  group('DataSync backup file', () {
    ...
    test(
      ...
      () async {
        ...
        final staleWorkDir = Directory('${tmpDir.path}/canary_backup_stale');
        await staleWorkDir.create(recursive: true);
        await File('${staleWorkDir.path}/orphan.zip').writeAsString('old');
        await File('${tmpDir.path}/canary_backup_old.zip').writeAsString('old');
        ...
        expect(
          await File('${tmpDir.path}/canary_backup_old.zip').exists(),
          isFalse,
        );
