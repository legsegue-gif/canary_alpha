  ...
  group('TtsServiceOptions', () {
    ...
    test('round-trips advanced fields for new TTS providers', () {
      final miniMax = MiniMaxTtsOptions(
        ...
        channel: 2,
        subtitleEnable: true,
        pronunciationDictionary: const <String>['Canary/ke-li-vo'],
      );
      final miniMaxAgain =
      ...
      expect(miniMaxAgain.pronunciationDictionary, <String>['Canary/ke-li-vo']);
