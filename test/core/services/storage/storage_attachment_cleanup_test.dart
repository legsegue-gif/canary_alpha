...
import 'package:Canary/core/services/storage/storage_usage_service.dart';
...
import 'package:Canary/core/services/workspace/workspace_tool_context.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      final messages = [
        _message('canary-file:///upload/%E6%8A%A5%E5%91%8A.txt'),
        _message(other.path),
      ];
