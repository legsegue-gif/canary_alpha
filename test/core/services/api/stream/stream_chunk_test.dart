...
void main() {
  test('ReasoningDelta carries Canary-specific details snapshot', () {
  ...
  test('completeRenderableImageUri wraps raw base64 only', () {
    ...
    expect(
      completeRenderableImageUri('canary-file:///images/a.png'),
  ...
  test('isCompleteImageUri distinguishes URLs from raw base64', () {
    ...
    expect(isCompleteImageUri('canary-file:///images/a.png'), isTrue);
