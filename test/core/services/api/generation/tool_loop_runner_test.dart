...
import 'package:Canary/core/services/api/stream/stream_chunk_ids.dart';
...
void main() {
    ...
    final chunks = await executeClientTools(
      calls: [
        emitToolCall(
          id: 'call_1',
          name: 'lookup',
          arguments: const <String, dynamic>{'q': 'canary'},
        ),
      ],
  ...
  test(
    ...
    () async {
      ...
      expect(streamResult.output, isNot(contains('"canary"')));
