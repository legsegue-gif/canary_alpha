...
import 'package:Canary/core/services/network/request_logger.dart';
import 'package:Canary/core/services/search/providers/tavily_search_service.dart';
import 'package:Canary/core/services/search/search_service.dart';
import 'package:Canary/core/services/search/search_service_usage_service.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('canary_search_logs_');
