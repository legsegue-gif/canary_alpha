...
import 'package:Canary/core/services/search/providers/firecrawl_search_service.dart';
import 'package:Canary/core/services/search/providers/stepfun_search_service.dart';
import 'package:Canary/core/services/search/providers/tinyfish_search_service.dart';
...
void main() {
  group('StepFun / Firecrawl / TinyFish search providers', () {
    test('StepFun posts /v1/search and parses results', () async {
      ...
      expect(jsonDecode(captured!.body)['query'], 'canary');
