...
Help the user turn a repeatable task into a skill that works in Canary. Write
...
that says what the skill does and when to use it; Canary shows only the first
...
Use the tools and path zones shown in the current conversation. Canary supports
...
- **Workspace with a working shell:** install directly into Canary's skills
  ...
  the complete SKILL.md last. Canary rescans installed skills after shell
...
entrypoint as `canary://skills/<skill-directory>/SKILL.md`, using the actual
